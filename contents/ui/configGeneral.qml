...
Item {
    ...
    MediaPlayer {
        ...
        audioOutput: AudioOutput {
            volume: page.cfg_soundVolume > 0 ? page.cfg_soundVolume : 1.0
        }
    }
    ...
    readonly property var teamColors: ({
        "ANA": "#F47A38", "UTA": "#6E2B62", "BOS": "#FFB81C", "BUF": "#003087",
    ...
    QQC2.ScrollView {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                columnSpacing: 16
                rowSpacing: 10
                QQC2.Label { text: i18n("Max games to display:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.SpinBox {
                    from: 1
                    to: 20
                ...
                QQC2.Label { text: i18n("Leaders limit:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.ComboBox {
                    model: [10, 20, 50]
                ...
                QQC2.Label { text: i18n("Franchise leaders limit:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.ComboBox {
                    model: [10, 20, 50]
                    property bool ready: false
                    Component.onCompleted: {
            ...
            ColumnLayout {
                ...
                QQC2.Label {
                    text: i18n("Match display interval (hours relative to now)")
                    font.bold: true
                    Layout.alignment: Qt.AlignHCenter
                }

                // Conteneur principal du slider (pour centrage parfait)
                ColumnLayout {
                    Layout.alignment: Qt.AlignHCenter
                    ...
                    QQC2.RangeSlider {
                        ...
                        first.value: -cfg_pastHours
                        second.value: cfg_upcomingHours

                        first.onValueChanged: {
                            if (first.value > 0) first.value = 0
                            cfg_pastHours = Math.abs(Math.round(first.value))
                        }
                        second.onValueChanged: {
                            if (second.value < 0) second.value = 0
                            cfg_upcomingHours = Math.round(second.value)
                        }
                    }
                    
                    // Légende alignée sur le slider
                    Item {
                        Layout.fillWidth: true
                        implicitHeight: 30
                        ...
                        QQC2.Label {
                            anchors.left: parent.left
                            text: i18n("Past (-%1h)", 60)
                            font.pixelSize: 9
                            opacity: 0.5
                        }
                        
                        QQC2.Label {
                            // Calcul du ratio pour aligner sur le point ZERO du slider
                            // Le slider va de -60 à +120 (total 180). Le ZERO est à 60/180 = 1/3
                            x: (parent.width * 60 / 180) - (width / 2)
                ...
                Rectangle {
                    Layout.alignment: Qt.AlignHCenter
                    implicitWidth: summaryLabel.implicitWidth + 30
                    implicitHeight: 30
                    ...
                    QQC2.Label {
                        id: summaryLabel
                        anchors.centerIn: parent
                        text: i18n("Showing games from <b>%1h</b> to <b>+%2h</b>", Math.round(timeRangeSlider.first.value), Math.round(timeRangeSlider.second.value))
                        font.pixelSize: 11
                    }
                }
            }
            ...
            GridLayout {
                ...
                columnSpacing: 16
                rowSpacing: 10
                QQC2.Label { text: i18n("Refresh interval:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.ComboBox {
                ...
                QQC2.Label { text: i18n("Enable system notifications:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.CheckBox {
                    checked: cfg_enableNotifications
                    onToggled: cfg_enableNotifications = checked
                }
                QQC2.Label { text: i18n("For all teams:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                QQC2.CheckBox {
                    enabled: cfg_enableNotifications
                    checked: cfg_notificationsAllTeams
                    onToggled: cfg_notificationsAllTeams = checked
                }
                QQC2.Label { text: i18n("Goal blink duration:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                RowLayout {
                    spacing: 8
                    QQC2.SpinBox {
                        from: 0
                    ...
                    QQC2.Label { text: i18n("sec."); opacity: 0.6 }
                }
                QQC2.Label { text: i18n("Goal sound volume:"); Layout.alignment: Qt.AlignRight | Qt.AlignVCenter }
                RowLayout {
                    spacing: 12
                    QQC2.Slider {
                        id: volSld
                    ...
                    QQC2.Label {
                        text: Math.round(volSld.value * 100) + "%"
