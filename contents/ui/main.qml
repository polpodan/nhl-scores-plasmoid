...
PlasmoidItem {
    ...
    Component { id: teamRowInline
        Row {
            ...
            Rectangle { radius: 4; color: teamColor(awayCode); border.color: 'white'; border.width: 1
                height: aText.implicitHeight + 1; width: aText.implicitWidth + 6
            ...
            Rectangle { radius: 4; color: teamColor(homeCode); border.color: 'white'; border.width: 1
                height: hText.implicitHeight + 1; width: hText.implicitWidth + 6
